    ...
    return(
        <section className={`${styles.collaborate_wrap} w-full pt-14 pb-6 px-0 md:px-0`}>
            <div className="inner_section w-full lg:max-w-5xl m-auto px-5 lg:px-10">
                ...
                <p className={`${styles.collaborate_description} py-4 md:w-3/4`}>Har du en idé som du vill verklighetställa? Jag gör <span className={styles.bolder}>mindre frilansprojekt</span> och har en bred kompetens inom många digitala områden.</p>

                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 md:pt-3 lg:px-5 lg:pt-8">
                    <div className="text-cols">
                        <p className={`${styles.collaborate_text}`}><span className={styles.bolder}>Exempel på projekt skulle kunna vara:</span> Portfolios, Webshoppar, Band-sidor (ja, dom behövs fortfarande), SaaS-startups, Magasin, förening/evenemang/klubbsidor eller bara en simpel blogg.</p>
